...
public class PasskeyLoginWidget extends com.strivacity.android.native_sdk.render.widgets.PasskeyLoginWidget {

    public PasskeyLoginWidget(Context context, WidgetModel.PasskeyLoginWidgetModel passkeyLoginWidgetModel) {
        super(context, passkeyLoginWidgetModel);
        switch (passkeyLoginWidgetModel.getRender().getType()) {
            case "button":
                ...
                if (Objects.equals(passkeyLoginWidgetModel.getRender().getHint().getVariant(), "primary")) {
