...
public class WebauthnLoginWidget extends com.strivacity.android.native_sdk.render.widgets.WebauthnLoginWidget {

    public WebauthnLoginWidget(Context context, WidgetModel.WebauthnLoginWidgetModel webauthnLoginWidgetModel) {
        super(context, webauthnLoginWidgetModel);
        switch (webauthnLoginWidgetModel.getRender().getType()) {
            case "button":
                ...
                if (Objects.equals(webauthnLoginWidgetModel.getRender().getHint().getVariant(), "primary")) {
