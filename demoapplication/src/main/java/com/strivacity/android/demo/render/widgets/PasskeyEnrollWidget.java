...
public class PasskeyEnrollWidget extends com.strivacity.android.native_sdk.render.widgets.PasskeyEnrollWidget {

    public PasskeyEnrollWidget(Context context, WidgetModel.PasskeyEnrollWidgetModel passkeyEnrollWidgetModel) {
        super(context, passkeyEnrollWidgetModel);
        switch (passkeyEnrollWidgetModel.getRender().getType()) {
            case "button":
                ...
                if (Objects.equals(passkeyEnrollWidgetModel.getRender().getHint().getVariant(), "primary")) {
